const credentials = {
  client: {
    id: "70e6d57f-9c92-4dda-b971-5a6aa5f2d1d3",
    secret: "bpavg@u?G7eqzv1-5LEtB]WTWw27/8a["
  },
  auth: {
...
function getAuthUrl() {
  ...
  const returnVal = oauth2.authorizationCode.authorizeURL({
    ...
    scope:
      "openid profile offline_access User.Read Mail.Read Calendars.Read Contacts.Read Mail.Send"
  });
